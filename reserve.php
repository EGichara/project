<?php
if(isset($_GET['sid'])){
    $vehicles = $conn->query("SELECT *,Concat(code,' - ',`name`) as vehicle FROM `vehicle_list` where id in (SELECT vehicle_id FROM `schedule_list` where delete_flag = 0 and id='{$_GET['sid']}')");
        ...
        <div class="card-body rounded-0">
            <div class="callout border-primary rounded-0"style="border:none;">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <dl>
                            <dt class="text-muted">Seater Fare:</dt>
                            <dd class="pl-3"><b><?= isset($first_class_fare) ? $first_class_fare : '--.--' ?> KSH</b></dd>
                            <dt class="text-muted">Shuttle Fare:</dt>
                            <dd class="pl-3"><b><?= isset($economy_fare) ? $economy_fare : "--.--" ?> KSH</b></dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <form action="" id="reserve-form">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group text-right">
                                    <button class="btn btn-danger btn-sm btn-flat btn-remove" type="button" style="background-color: green; border-color: green;"><i class="fa fa-trash"></i> Remove</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between my-2">
                    <div class="form-group">
                        <button class="btn btn-sm btn-info btn-flat" type="button" id="add_item" style="background-color:green;"><i class="fa fa-plus"></i> Add Passenger</button>
                    </div>
                    <div class="form-group">
                        
                        <button class="btn btn-sm btn-primary btn-flat"style ="background-color: green;">Book Reservations</button>
                    </div>
                </div>
                <!-- List Group -->
