...
<div class="container-fluid">
    <form action="" id="vehicle-form">
        ...
        <div class="form-group">
            <label for="code" class="control-label">Vehicle</label>
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter vehicle Name" value ="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="first_class_capacity" class="control-label">Seater</label>
        ...
        <div class="form-group">
            <label for="economy_capacity" class="control-label">Shuttle</label>
...
<script>
    $(function(){
        $('#uni_modal #vehicle-form').submit(function(e){
            e.preventDefault();
            var _this = $(this)
            $('.pop-msg').remove()
            var el = $('<div>')
